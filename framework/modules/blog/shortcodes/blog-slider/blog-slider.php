<?php
namespace KvellCore\CPT\Shortcodes\BlogSlider;
...
class BlogSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Edge Blog Slider', 'kvell' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							esc_html__( 'Slider', 'kvell' )            => 'slider',
							esc_html__( 'Carousel', 'kvell' )          => 'carousel',
							esc_html__( 'Carousel Centered', 'kvell' ) => 'carousel-centered'
						),
						'save_always' => true
					),
					array(
	...
	public function render( $atts, $content = null ) {
		...
		kvell_edge_get_module_template_part( 'shortcodes/blog-slider/holder', 'blog', '', $params );
