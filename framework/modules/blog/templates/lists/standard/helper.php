...
if ( ! function_exists( 'kvell_edge_get_blog_holder_classes' ) ) {
	/**
	 * Function that generates blog holder classes for blog page
	 */
	function kvell_edge_get_blog_holder_classes( $classes ) {
	...
	add_filter( 'kvell_edge_blog_holder_classes', 'kvell_edge_get_blog_holder_classes' );
}
