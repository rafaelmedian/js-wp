...
if ( ! function_exists( 'kvell_edge_get_hide_dep_for_header_main_menu_options' ) ) {
	function kvell_edge_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'kvell_edge_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'kvell_edge_header_main_navigation_options_map' ) ) {
	function kvell_edge_header_main_navigation_options_map() {
		$hide_dep_options = kvell_edge_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = kvell_edge_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'kvell' ),
		...
		kvell_edge_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'kvell' )
			)
		);
		
		$drop_down_group = kvell_edge_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'drop_down_group',
				'title'       => esc_html__( 'Main Dropdown Menu', 'kvell' ),
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'kvell' )
			)
		);
		
		$drop_down_row1 = kvell_edge_add_admin_row(
			array(
		...
		kvell_edge_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'kvell' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'kvell' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'kvell' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'kvell' )
				)
			)
		);
		...
		$first_level_group = kvell_edge_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'kvell' )
			)
		);
		...
		kvell_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'kvell' ),
			)
		);
		...
		kvell_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'kvell' ),
			)
		);
		
		$first_level_row4 = kvell_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		kvell_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'kvell' ),
			)
		);
		...
		kvell_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'kvell' ),
			)
		);
		
		$first_level_row5 = kvell_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = kvell_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = kvell_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		kvell_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'kvell' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		kvell_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'kvell' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = kvell_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'kvell' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'kvell' )
			)
		);
		...
		kvell_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover/Active Color', 'kvell' )
			)
		);
		...
		$second_level_wide_group = kvell_edge_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'kvell' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'kvell' )
			)
		);
		
		$second_level_wide_row1 = kvell_edge_add_admin_row(
			array(
		...
		$second_level_wide_row2 = kvell_edge_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = kvell_edge_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = kvell_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( '3nd Level Menu', 'kvell' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'kvell' )
			)
		);
		...
		$third_level_row3 = kvell_edge_add_admin_row(
			array(
				'parent' => $third_level_group,
		...
		$third_level_wide_group = kvell_edge_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'kvell' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'kvell' )
			)
		);
		
		$third_level_wide_row1 = kvell_edge_add_admin_row(
			array(
		...
		$third_level_wide_row2 = kvell_edge_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = kvell_edge_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'kvell_edge_header_main_navigation_options_map', 'kvell_edge_header_main_navigation_options_map', 10, 1 );
}