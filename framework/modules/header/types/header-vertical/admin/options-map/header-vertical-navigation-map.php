...
if ( ! function_exists( 'kvell_edge_get_hide_dep_for_header_vertical_menu_options' ) ) {
	function kvell_edge_get_hide_dep_for_header_vertical_menu_options() {
		$hide_dep_options = apply_filters( 'kvell_edge_header_vertical_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'kvell_edge_header_vertical_navigation_options_map' ) ) {
	function kvell_edge_header_vertical_navigation_options_map() {
		$hide_dep_options = kvell_edge_get_hide_dep_for_header_vertical_menu_options();
		
		$panel_vertical_main_menu = kvell_edge_add_admin_panel(
			array(
				'title'           => esc_html__( 'Vertical Main Menu', 'kvell' ),
		...
		$drop_down_group = kvell_edge_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Set a style for dropdown menu', 'kvell' )
			)
		);
		
		$vertical_drop_down_row1 = kvell_edge_add_admin_row(
			array(
		...
		kvell_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Top Margin', 'kvell' ),
				'args'          => array(
					'suffix' => 'px'
				),
		...
		kvell_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Bottom Margin', 'kvell' ),
				'args'          => array(
					'suffix' => 'px'
				),
				'parent'        => $vertical_drop_down_row1
		...
		kvell_edge_add_admin_field(
			array(
				...
				'default_value' => 'below',
				'label'         => esc_html__( 'Submenu Opening', 'kvell' ),
				'options'		=> array(
					'below' => esc_html__('Below', 'kvell'),
					'side' => esc_html__('On Side', 'kvell'),
				),
				'parent'        => $panel_vertical_main_menu
			)
		);

		$group_vertical_first_level = kvell_edge_add_admin_group(
			array(
				'name'        => 'group_vertical_first_level',
				'title'       => esc_html__( '1st level', 'kvell' ),
				'description' => esc_html__( 'Define styles for 1st level menu', 'kvell' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_first_level_1 = kvell_edge_add_admin_row(
			array(
		...
		$row_vertical_first_level_2 = kvell_edge_add_admin_row(
			array(
		...
		$row_vertical_first_level_3 = kvell_edge_add_admin_row(
			array(
		...
		$group_vertical_second_level = kvell_edge_add_admin_group(
			array(
				'name'        => 'group_vertical_second_level',
				'title'       => esc_html__( '2nd level', 'kvell' ),
				'description' => esc_html__( 'Define styles for 2nd level menu', 'kvell' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_second_level_1 = kvell_edge_add_admin_row(
			array(
		...
		$row_vertical_second_level_2 = kvell_edge_add_admin_row(
			array(
		...
		$row_vertical_second_level_3 = kvell_edge_add_admin_row(
			array(
		...
		$group_vertical_third_level = kvell_edge_add_admin_group(
			array(
				'name'        => 'group_vertical_third_level',
				'title'       => esc_html__( '3rd level', 'kvell' ),
				'description' => esc_html__( 'Define styles for 3rd level menu', 'kvell' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_third_level_1 = kvell_edge_add_admin_row(
			array(
		...
		$row_vertical_third_level_2 = kvell_edge_add_admin_row(
			array(
		...
		$row_vertical_third_level_3 = kvell_edge_add_admin_row(
			array(
	...
	add_action( 'kvell_edge_additional_header_main_navigation_options_map', 'kvell_edge_header_vertical_navigation_options_map', 10, 1 );
}