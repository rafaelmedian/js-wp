...
if (!class_exists('KvellEdgeStickyNavigationWalker')) {
	class KvellEdgeStickyNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
                ...
                $item_output .= '<span class="item_plus_mark"></span>';
