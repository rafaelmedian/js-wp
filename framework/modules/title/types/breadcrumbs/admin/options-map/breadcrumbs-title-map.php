...
if ( ! function_exists('kvell_edge_breadcrumbs_title_type_options_map') ) {
	function kvell_edge_breadcrumbs_title_type_options_map($panel_typography) {
		
		kvell_edge_add_admin_section_title(
			array(
				'name'   => 'type_section_breadcrumbs',
				'title'  => esc_html__( 'Breadcrumbs', 'kvell' ),
				'parent' => $panel_typography
			)
		);
	
		$group_page_breadcrumbs_styles = kvell_edge_add_admin_group(
			array(
				'name'        => 'group_page_breadcrumbs_styles',
				'title'       => esc_html__( 'Breadcrumbs', 'kvell' ),
				'description' => esc_html__( 'Define styles for page breadcrumbs', 'kvell' ),
				'parent'      => $panel_typography
			)
		);
	
			$row_page_breadcrumbs_styles_1 = kvell_edge_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_2 = kvell_edge_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_3 = kvell_edge_add_admin_row(
				array(
	...
	add_action( 'kvell_edge_additional_title_typography_options_map', 'kvell_edge_breadcrumbs_title_type_options_map');
}