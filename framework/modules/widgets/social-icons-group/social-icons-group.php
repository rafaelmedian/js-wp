...
class KvellEdgeClassIconsGroupWidget extends KvellEdgeWidget {
	public function __construct() {
		parent::__construct(
			'edgtf_social_icons_group_widget',
			esc_html__( 'Edge Social Icons Group Widget', 'kvell' ),
			array( 'description' => esc_html__( 'Use this widget to add a group of up to 6 social icons to a widget area.', 'kvell' ) )
		);
	...
	protected function setParams() {
		$this->params = array_merge(
			...
			kvell_edge_icon_collections()->getSocialIconWidgetMultipleParamsArray(6),
			array(
				array(
					'type'    => 'dropdown',
					'name'    => 'layout',
					'title'   => esc_html__( 'Icons Layout', 'kvell' ),
					'options' => array(
						''             => esc_html__( 'Default', 'kvell' ),
						'square-icons' => esc_html__( 'Square', 'kvell' ),
					)
				),
				array(
					'type'        => 'dropdown',
					'name'        => 'skin',
					'title'       => esc_html__( 'Square Icons Skin', 'kvell' ),
					'description' => esc_html__( 'This applies to the square layout', 'kvell' ),
					'options'     => array(
						''           => esc_html__( 'Dark Skin', 'kvell' ),
						'light-skin' => esc_html__( 'Light Skin', 'kvell' ),
					)
				),
				array(
					'type'    => 'dropdown',
					'name'    => 'alignment',
					'title'   => esc_html__( 'Text Alignment', 'kvell' ),
					'options' => array(
				...
				array(
					'type'  => 'textfield',
					'name'  => 'icon_size',
					'title' => esc_html__( 'Icons Size (px)', 'kvell' )
				),
				array(
					'type'  => 'colorpicker',
					'name'  => 'color',
	...
	public function widget( $args, $instance ) {
		...
		for ( $n = 1; $n <= 6; $n++ ) {
			...
			<?php if ( ! empty( $icon_holder_html ) ) { ?>
				<a class="edgtf-social-icon-widget-holder edgtf-icon-has-hover" <?php echo kvell_edge_get_inline_attr( $hover_color, 'data-hover-color' ); ?> <?php kvell_edge_inline_style( $icon_styles ) ?>
